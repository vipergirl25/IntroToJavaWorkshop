...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	private void showScaryImage(String scarypicture) {
		try {
			maze = ImageIO.read(getClass().getResource(scarypicture));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + scarypicture);
		}
		repaint();
	}
